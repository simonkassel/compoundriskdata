...
vars <- c("EXISTING_RISK_COVID_RESPONSE_CAPACITY", 
          "EXISTING_RISK_FOOD_SECURITY",
          "EXISTING_RISK_MACROECONOMIC_EXPOSURE_TO_COVID",
          "EXISTING_RISK_FISCAL", 
          "EXISTING_RISK_SOCIOECONOMIC_VULNERABILITY",
